...
<template>
  <main>
    <div class="">welcome to this platform where you can find accomodations within your area so easily</div>
    <button class=" bg-green-600 p-5">get started</button>


    
<footer class="bg-white dark:bg-gray-900">
    <div class="grid grid-cols-2 gap-8  px-6 md:grid-cols-4">
        <div>
